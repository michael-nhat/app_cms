<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:64:"/www/wwwroot/maccms10test2/application/admin/view/art/index.html";i:1665150455;s:66:"/www/wwwroot/maccms10test2/application/admin/view/public/head.html";i:1665150455;s:66:"/www/wwwroot/maccms10test2/application/admin/view/public/foot.html";i:1665150455;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
...
<div class="page-container p10">
    ...
    <div class="my-toolbar-box">
            ...
            <form class="layui-form " method="post" action="<?php echo url('data'); ?>">
                ...
                <div class="layui-input-inline w150">
                    <select name="order">
                        ...
                        <option value="art_time" <?php if($param['order'] == 'art_time'): ?>selected<?php endif; ?>><?php echo lang('update_time'); ?></option>
                        <option value="art_id" <?php if($param['order'] == 'art_id'): ?>selected<?php endif; ?>><?php echo lang('id'); ?></option>
                        <option value="art_hits" <?php if($param['order'] == 'art_hits'): ?>selected<?php endif; ?>><?php echo lang('hits'); ?></option>
                        <option value="art_hits_month" <?php if($param['order'] == 'art_hits_month'): ?>selected<?php endif; ?>><?php echo lang('hits_month'); ?></option>
                        <option value="art_hits_week" <?php if($param['order'] == 'art_hits_week'): ?>selected<?php endif; ?>><?php echo lang('hits_week'); ?></option>
                        <option value="art_hits_day" <?php if($param['order'] == 'art_hits_day'): ?>selected<?php endif; ?>><?php echo lang('hits_day'); ?></option>
                    </select>
                </div>
        ...
        <div class="layui-btn-group">
            ...
            <a data-href="<?php echo url('index/select'); ?>?tab=art&col=type_id&tpl=select_type&url=art/field" data-width="270" data-height="100" data-checkbox="1" class="layui-btn layui-btn-primary j-select"><i class="layui-icon">&#xe620;</i><?php echo lang('type'); ?></a>
            <a data-href="<?php echo url('index/select'); ?>?tab=art&col=art_level&tpl=select_level&url=art/field" data-width="270" data-height="100" data-checkbox="1" class="layui-btn layui-btn-primary j-select"><i class="layui-icon">&#xe620;</i><?php echo lang('level'); ?></a>
            <a data-href="<?php echo url('index/select'); ?>?tab=art&col=art_hits&tpl=select_hits&url=art/field" data-width="470" data-height="100" data-checkbox="1" class="layui-btn layui-btn-primary j-select"><i class="layui-icon">&#xe620;</i><?php echo lang('hits'); ?></a>
            <a data-href="<?php echo url('index/select'); ?>?tab=art&col=art_status&tpl=select_status&url=art/field" data-width="470" data-height="100" data-checkbox="1" class="layui-btn layui-btn-primary j-select"><i class="layui-icon">&#xe620;</i><?php echo lang('status'); ?></a>
            <a data-href="<?php echo url('index/select'); ?>?tab=art&col=art_lock&tpl=select_lock&url=art/field" data-width="470" data-height="100" data-checkbox="1" class="layui-btn layui-btn-primary j-select"><i class="layui-icon">&#xe620;</i><?php echo lang('lock'); ?></a>
            <a class="layui-btn layui-btn-primary j-iframe" data-href="<?php echo url('images/opt?tab=art'); ?>" href="javascript:;" title="<?php echo lang('pic_sync'); ?>"><i class="layui-icon">&#xe620;</i><?php echo lang('pic_sync'); ?></a>
            <a class="layui-btn layui-btn-primary j-iframe" data-checkbox="true" data-href="<?php echo url('make/make?ac=info&tab=art'); ?>" href="javascript:;" title="<?php echo lang('make_page'); ?>"><i class="layui-icon">&#xe620;</i><?php echo lang('make_page'); ?></a>
    ...
    <form class="layui-form " method="post" id="pageListForm">
        <table class="layui-table" lay-size="sm">
            ...
            <tr>
                ...
                <th width="80"><?php echo lang('author'); ?></th>
            ...
            <tr>
                ...
                <td>[<?php echo mac_restore_htmlfilter(mac_filter_xss($vo['type']['type_name'])); ?>] <a target="_blank" class="layui-badge-rim " href="<?php echo mac_url_art_detail($vo); ?>"><?php echo mac_restore_htmlfilter(mac_filter_xss($vo['art_name'])); ?></a> <?php if($vo['art_status'] == 0): ?> <span class="layui-badge"><?php echo lang('reviewed_not'); ?></span><?php endif; if($vo['art_lock'] == 1): ?> <span class="layui-badge"><?php echo lang('lock'); ?></span><?php endif; ?></td>
                ...
                <td><?php echo htmlspecialchars($vo['art_author']); ?></td>
                <td><?php echo mac_day($vo['art_time'],'color'); ?></td>
                <td>
                    <a class="layui-badge-rim j-iframe" data-full="1" data-href="<?php echo url('info?id='.$vo['art_id']); ?>" href="javascript:;" title="<?php echo lang('edit'); ?>"><?php echo lang('edit'); ?></a>
                    <a class="layui-badge-rim j-tr-del" data-href="<?php echo url('del?ids='.$vo['art_id']); ?>" href="javascript:;" title="<?php echo lang('del'); ?>"><?php echo lang('del'); ?></a>
                </td>
            </tr>
