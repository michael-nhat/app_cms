<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:68:"/www/wwwroot/maccms10test2/application/admin/view/website/batch.html";i:1665150455;s:66:"/www/wwwroot/maccms10test2/application/admin/view/public/head.html";i:1665150455;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
    ...
    <form class="layui-form" method="post" action="">
        ...
        <fieldset class="layui-elem-field">
            ...
            <div class="layui-field-box">
                ...
                <div class="layui-form-item">
                    <button type="button" class="layui-btn btn_submit"><?php echo lang('del_multi'); ?></button>
                </div>
            </div>
        </fieldset>
        ...
        <div class="layui-field-box">
            ...
            <div class="layui-form-item">
                <button type="submit" class="layui-btn btn_submit"><?php echo lang('start_exec'); ?></button>
            </div>
